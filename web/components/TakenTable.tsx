...
export function TakenTable() {
  ...
  if (status === 'loading') {
    return <div className="text-center py-24 text-zinc-500 text-sm">Loading taken bets…</div>
  }
  if (status === 'error') {
    return <div className="text-center py-24 text-red-500 text-sm">Failed to load taken bets.</div>
  }
